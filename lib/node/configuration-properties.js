...
export class ConfigurationProperties {
  ...
  constructor(defaults, prefix, name, locations, fs) {
    ...
    this.#prefix = prefix;
    // TODO read name and location from env and args
    this.#name = name;
  ...
  async get() {
    ...
    // TODO Interprete placeholders like ${foo.bar}
    // TODO Interprete placeholders with default value like ${foo.bar:default}
